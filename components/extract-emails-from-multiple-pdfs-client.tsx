...
export default function ExtractEmailsFromMultiplePDFsClient() {
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes. This page is built for batch workflows where you want to process several PDF files and combine the extracted email addresses into one final list.',
    },
    {
      question: 'Will duplicate emails be removed?',
      answer:
        'Yes. Duplicate email addresses found across multiple PDF files are automatically removed before the final list is shown.',
    },
    {
      question: 'Why were no emails found across my PDF files?',
      answer:
        'Usually this means one or more files are scanned, image-based, contain no visible email addresses, or have formatting that makes extraction harder.',
    },
    {
      question: 'What types of PDFs work best in bulk mode?',
      answer:
          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
                Extract email addresses from multiple PDF files in one run. Upload several PDFs,
                merge the results, and get one clean deduplicated email list ready to copy.
              </p>

              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-500">
                Best for text-based PDFs. If some files are scanned or image-based, you may also
                need the{' '}
                <Link
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-600">
                        Select multiple PDF files in one upload instead of repeating the single-file
                        workflow.
                      </p>
                    </div>
                  </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-semibold text-slate-900">
                        Get one combined email list
                      </h2>
                      <p className="mt-2 text-sm leading-6 text-slate-600">
                        Merge extracted email addresses from all selected files into one final list.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-600">
                        Duplicate email addresses are removed automatically before the results are
                        shown.
                      </p>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <h2 className="text-lg font-semibold text-slate-900">Upload multiple PDFs</h2>
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Select more than one PDF file and combine all extracted email addresses into
                      one list.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  {!isLoading && !error && hasSearched && emails.length === 0 && (
                    <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-amber-800">
                      No email addresses were found across the selected PDF files. One or more
                      files may be scanned, image-based, or simply not contain visible email text.
                      See the{' '}
                      <Link
                        href="/extract-emails-from-scanned-pdf"
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:px-8">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-3 text-lg font-semibold text-slate-900">Select several PDFs</h3>
            <p className="mt-2 text-sm leading-6 text-slate-600">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-3 text-lg font-semibold text-slate-900">Merge all extracted emails</h3>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Combine extracted email addresses from all selected files into one final result.
            </p>
          </div>

          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="text-sm font-semibold text-slate-500">Step 3</div>
            <h3 className="mt-3 text-lg font-semibold text-slate-900">Remove duplicates automatically</h3>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Duplicate email addresses found across multiple PDFs are filtered out so the final
              list is cleaner and easier to use.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50">
        <div className="mx-auto max-w-6xl px-6 py-16 md:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900">
              Single PDF vs multiple PDF email extraction
            </h2>
            <p className="mt-4 text-slate-600">
              Use the main extractor for one file. Use this page when you need one combined email
              list from several PDFs.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-slate-900">Single PDF extractor</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Best when you only need to process one PDF at a time and want a simple standard
                extraction flow.
              </p>
              <Link
                href="/"
                className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-slate-700 underline underline-offset-4 hover:text-slate-900"
              >
                Go to the main PDF extractor
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-slate-900">Multiple PDF extractor</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Best when you want to process several PDFs and combine all extracted email
                addresses into one deduplicated list.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <p className="mt-4 text-slate-600">
                This page is a better fit when your workflow involves folders, repeated uploads, or
                repeated copy-paste steps that can be simplified into one combined run.
              </p>
            </div>
